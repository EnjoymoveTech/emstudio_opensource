...
const char IDE_DISPLAY_NAME[] = "Em Studio";
const char IDE_ID[] = "emstudio";
const char IDE_CASED_ID[] = "EmStudio";

#define IDE_VERSION 2.1.600_2023_01_06
#define IDE_VERSION_STR STRINGIFY(IDE_VERSION)
#define IDE_VERSION_DISPLAY_DEF 2.1.600
#define IDE_VERSION_COMPAT_DEF 2.1.600

#define IDE_VERSION_MAJOR 2
#define IDE_VERSION_MINOR 1
#define IDE_VERSION_RELEASE 600
...
const char IDE_AUTHOR[]            = "The EnjoyMove Company Ltd";
const char IDE_YEAR[]              = "2023";
...
#else
const char IDE_SETTINGSVARIANT_STR[]      = "EmosProject2";
#endif
