...
#include <generaleditor/codeassist/assistproposaliteminterface.h>
...
public:
    ...
    // Workaround EMSTUDIOBUG-11653
    void calculateMaximumWidth()
    {

        const int desktopWidth = focusWidget()->geometry().width();
...
void GenericProposalWidget::updatePositionAndSize()
{
    ...
    const QRect screen =  d->m_underlyingWidget->geometry();
