...
#include <generaleditor/codeassist/assistinterface.h>
#include <generaleditor/codeassist/codeassistant.h>
#include <generaleditor/codeassist/completionassistprovider.h>
#include <generaleditor/codeassist/documentcontentcompletion.h>
...
static const char kTextBlockMimeType[] = "application/vnd.emstudio.blocktext";
...
QMimeData *TextEditorWidget::createMimeDataFromSelection() const
{
    if (d->m_inBlockSelectionMode) {
        ...
        /*
          ...
          including indentation in the emstudio.blocktext mimetype.
        */
