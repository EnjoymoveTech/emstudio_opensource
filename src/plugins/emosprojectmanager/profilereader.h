...
namespace Internal { class QmakeProjectManagerPlugin; }

class EMOSPROJECTMANAGER_EXPORT ProMessageHandler : public QMakeHandler
{
public:
...
class EMOSPROJECTMANAGER_EXPORT ProFileReader : public QObject, public ProMessageHandler, public QMakeParser, public ProFileEvaluator
{
    Q_OBJECT
...
class EMOSPROJECTMANAGER_EXPORT ProFileCacheManager : public QObject
{
    Q_OBJECT
...
private:
    ...
    friend class QmakeProjectManager::Internal::QmakeProjectManagerPlugin;
};
