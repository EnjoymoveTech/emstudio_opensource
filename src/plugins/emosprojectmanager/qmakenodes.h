...
#include <explorer/buildsystem.h>
...
class EMOSPROJECTMANAGER_EXPORT QmakePriFileNode : public ProjectExplorer::ProjectNode
{
public:
    ...
    bool showInSimpleTree() const override { return true; }//haojie.fang 显示简易信息
...
class EMOSPROJECTMANAGER_EXPORT QmakeProFileNode : public QmakePriFileNode
{
public:
