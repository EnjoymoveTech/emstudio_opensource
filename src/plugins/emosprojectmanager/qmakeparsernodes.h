...
class EMOSPROJECTMANAGER_EXPORT QmakePriFile
{
public:
...
protected:
    ...
    static QStringList varNames(ProjectExplorer::FileType type, ProFileReader *readerExact);
...
private:
    ...
    static QStringList baseVPaths(ProFileReader *reader, const QString &projectDir, const QString &buildDir);
    static QStringList fullVPaths(const QStringList &baseVPaths, ProFileReader *reader, const QString &qmakeVariable, const QString &projectDir);
...
class EMOSPROJECTMANAGER_EXPORT TargetInformation
{
public:
    bool valid = false;
    QString target;
...
class EMOSPROJECTMANAGER_EXPORT InstallsItem {
public:
...
class EMOSPROJECTMANAGER_EXPORT InstallsList {
public:
...
class EMOSPROJECTMANAGER_EXPORT QmakeProFile : public QmakePriFile
{
public:
...
private:
    ...
    static QString uiDirPath(ProFileReader *reader, const Utils::FilePath &buildDir);
    static QString mocDirPath(ProFileReader *reader, const Utils::FilePath &buildDir);
    static QString sysrootify(const QString &path, const QString &sysroot, const QString &baseDir, const QString &outputDir);
    static QStringList includePaths(ProFileReader *reader, const Utils::FilePath &sysroot, const Utils::FilePath &buildDir, const QString &projectDir);
    static QStringList libDirectories(ProFileReader *reader);
    static Utils::FilePaths subDirsPaths(ProFileReader *reader, const QString &projectDir, QStringList *subProjectsNotToDeploy, QStringList *errors);

    static TargetInformation targetInformation(ProFileReader *reader, ProFileReader *readerBuildPass, const Utils::FilePath &buildDir, const Utils::FilePath &projectFilePath);
    static InstallsList installsList(const ProFileReader *reader, const QString &projectFilePath, const QString &projectDir, const QString &buildDir);
    ...
    ProFileReader *m_readerExact = nullptr;
    ProFileReader *m_readerCumulative = nullptr;
};
