...
public:
    ...
    UrlLocatorFilter m_bugFilter{UrlLocatorFilter::tr("Qt Project Bugs"), "EmStudioBugs"};
#ifdef Q_OS_MACOS
...
void Locator::refresh(QList<ILocatorFilter *> filters)
{
    ...
    ProgressManager::addTask(m_refreshTask, tr("Updating Emos Project"), Constants::TASK_INDEX);
