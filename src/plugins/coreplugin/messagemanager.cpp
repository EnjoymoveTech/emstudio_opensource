...
void MessageManager::hideOutputPane()
{
    m_messageOutputWindow->hide();
}
...
void MessageManager::writeMessages(const QStringList &messages, Utils::OutputFormat foramt, PrintToOutputPaneFlags flags)
{
    write(messages.join('\n'), foramt, flags);
}

void MessageManager::write(const QString &text, Utils::OutputFormat foramt, PrintToOutputPaneFlags flags)
{
...
void MessageManager::writeWithTime(const QString &text, Utils::OutputFormat foramt, PrintToOutputPaneFlags flags)
{
    const QString timeStamp = QTime::currentTime().toString("HH:mm:ss ");
    write(timeStamp + text, foramt, flags);
}

void MessageManager::doWrite(const QString &text, Utils::OutputFormat foramt, PrintToOutputPaneFlags flags)
{
    QTC_ASSERT(m_messageOutputWindow, return);
