...
void GeneralSettingsWidget::fillLanguageBox()
{
    ...
    const QStringList languageFiles = QDir(creatorTrPath).entryList(QStringList(QLatin1String("emstudio*.qm")));
    ...
    m_ui.languageBox->setCurrentIndex(1);
    //setLanguage(m_ui.languageBox->itemData(1, Qt::UserRole).toString());
}
