...
static void*  m_emos_runtime = NULL;
...
{
    // Create emstudio dir if it doesn't yet exist
...
void ICore::updateNewItemDialogState()
{
 ...
 void ICore::setEmosRuntime(void* pRuntime)
 {
     m_emos_runtime = pRuntime;

 }

void* ICore::getEmosRuntime()
{
    return m_emos_runtime;
}
