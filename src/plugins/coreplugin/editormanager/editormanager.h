...
public:
    ...
    // add API/TYPE for distinguishing
    ...
    static bool closeDocuments(const QList<IDocument *> &documents, bool askAboutModifiedEditors = false);
    ...
    static bool closeEditors(const QList<IEditor *> &editorsToClose, bool askAboutModifiedEditors = false);
    ...
    static void setEmptyWidget(QWidget* w);
public: // for tests
...
signals:
    ...
    void autoCreateNewFile(const Utils::MimeType& type, const void* data, const DescriptionType& fileType, const ProjectExplorer::Project* project);
