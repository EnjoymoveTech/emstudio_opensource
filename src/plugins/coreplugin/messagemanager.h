...
public:
    ...
    static void writeMessages(const QStringList &messages, Utils::OutputFormat foramt = Utils::NormalMessageFormat,
                              PrintToOutputPaneFlags flags = NoModeSwitch);
    static void write(const QString &text, Utils::OutputFormat foramt = Utils::NormalMessageFormat, PrintToOutputPaneFlags flags = NoModeSwitch);
    static void writeWithTime(const QString &text, Utils::OutputFormat foramt = Utils::NormalMessageFormat, PrintToOutputPaneFlags flags = NoModeSwitch);
