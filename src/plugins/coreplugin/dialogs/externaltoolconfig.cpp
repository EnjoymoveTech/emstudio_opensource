...
QMimeData *ExternalToolModel::mimeData(const QModelIndexList &indexes) const
{
    ...
    md->setData("application/emstudio-externaltool-config", ba);
    return md;
}
                                     ...
                                     const QModelIndex &parent)
{
    ...
    QByteArray ba = data->data("application/emstudio-externaltool-config");
    if (ba.isEmpty())
        return false;
...
{
    return QStringList("application/emstudio-externaltool-config");
}
