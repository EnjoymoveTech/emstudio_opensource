...
void DFactory::visitMObject(const MObject *object)
{
    ...
    diagramObject->setOid(object->oid());//haojie.fang DObejct传递oid
...
void DFactory::visitMComponent(const MComponent *component)
{
    ...
    diagramComponent->setServiceInfo(component->serviceInfo());
    diagramComponent->setPropertyInfo(component->propertyInfo());
