...
public:
    ...
    const Style *applyBoundaryStyle(const Style *baseStyle, const DBoundary *boundary,
                                    const Parameters *parameters) override;
    const Style *applyDeviceStyle(const Style *baseStyle, const DDevice *boundary,
                                    const Parameters *parameters) override;
...
private:
    ...
    const Style *applyDeviceStyle(const Style *baseStyle, const Parameters *parameters);
    ...
    QHash<DeviceStyleKey, const Style *> m_deviceStyleMap;
