...
public:
    ...
    const Style *adaptDeviceStyle(const DDevice *device);
    const Style *adaptSwimlaneStyle(const DSwimlane *swimlane);
    const Style *relationStarterStyle();
    //haojie.fang add style
    const Style *methodStarterStyle();
    const Style *eventStarterStyle();
    const Style *fieldStarterStyle();
    const Style *pinStarterStyle();

private:
    QScopedPointer<Style> m_defaultStyle;
    QScopedPointer<Style> m_relationStarterStyle;
    QScopedPointer<Style> m_methodStarterStyle;
    QScopedPointer<Style> m_eventStarterStyle;
    QScopedPointer<Style> m_fieldStarterStyle;
    QScopedPointer<Style> m_pinStarterStyle;
