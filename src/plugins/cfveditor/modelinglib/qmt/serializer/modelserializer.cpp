...
// MElement
//lingfei.yu MElement 全名是 modelElement
...
inline void Access<Archive, MElement>::serialize(Archive &archive, MElement &element)
{
    archive || tag(element)
            ...
            || attr("oid", element, &MElement::oid, &MElement::setOid)//haojie.fang add oid
...
// MObject
//MObject类型默认带name children relations三种属性
...
inline void Access<Archive, MComponent>::serialize(Archive &archive, MComponent &component)
{
    archive || tag(component)
            ...
            || attr("serviceInfo", component, &MComponent::serviceInfo, &MComponent::setServiceInfo)
            || attr("propertyInfo", component, &MComponent::propertyInfo, &MComponent::setPropertyInfo)
            || attr("pinInfo", component, &MComponent::pinInfo, &MComponent::setPinInfo)
            || end;
}
...
//lingfei.yu relation add dest and source
template<class Archive>
inline void Access<Archive, MRelation>::serialize(Archive &archive, MRelation &relation)
{
    archive || tag(relation)
            ...
            || attr("a_oid", relation, &MRelation::endAOid, &MRelation::setEndAOid)//haojie.fang add oid
            || attr("a_name", relation, &MRelation::endAName, &MRelation::setEndAName)//
            || attr("b", relation, &MRelation::endBUid, &MRelation::setEndBUid)
            || attr("b_name", relation, &MRelation::endBName, &MRelation::setEndBName)
            || attr("b_oid", relation, &MRelation::endBOid, &MRelation::setEndBOid)
            || end;
}
...
inline void Access<Archive, MAssociationEnd>::serialize(Archive &archive, MAssociationEnd &associationEnd)
{
    archive || tag(associationEnd)
            ...
            || attr("kindName", associationEnd, &MAssociationEnd::kindName, &MAssociationEnd::setKindName)
            || end;
}
...
inline void Access<Archive, MAssociation>::serialize(Archive &archive, MAssociation &association)
{
    archive || tag(association)
            ...
            || attr("eventMap", association, &MAssociation::getEventMap, &MAssociation::setEventMap)
            || attr("fieldMap", association, &MAssociation::getFieldMap, &MAssociation::setFieldMap)
            || attr("pinMap", association, &MAssociation::getPinMap, &MAssociation::setPinMap)
            || end;
}
