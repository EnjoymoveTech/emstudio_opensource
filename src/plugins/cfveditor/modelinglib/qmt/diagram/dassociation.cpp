...
QString DAssociationEnd::kindName() const
{
    switch(m_kind)
    {
...
void DAssociation::setEventMap(QHash<QString, QString> map)
{
    m_eventMap = map;
}

void DAssociation::setFieldMap(QHash<QString, QString> map)
{
    m_fieldMap = map;
}

void DAssociation::setPinMap(QHash<QString, QString> pin)
{
    m_pinMap = pin;
}
