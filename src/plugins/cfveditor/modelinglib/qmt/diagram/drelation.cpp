...
void DRelation::setEndAOid(const QString &oid)
{
    m_endAOid = oid;
}

void DRelation::setEndBOid(const QString &oid)
{
    m_endBOid = oid;
}

void DRelation::setEndAName(const QString &name)
{
    m_endAName = name;
}

void DRelation::setEndBName(const QString &name)
{
    m_endBName = name;
}
