...
public:
    ...
    void setKindName(const QString&){};
...
public:
    ...
    void setEventMap(QHash<QString,QString> map);
    QHash<QString,QString> getEventMap() const { return m_eventMap; }
    void setFieldMap(QHash<QString,QString> map);
    QHash<QString,QString> getFieldMap() const { return m_fieldMap; }
    void setPinMap(QHash<QString,QString> map);
    QHash<QString,QString> getPinMap() const { return m_pinMap; }
...
private:
    ...
    QHash<QString,QString> m_eventMap;
    QHash<QString,QString> m_fieldMap;
    QHash<QString,QString> m_pinMap;
};
