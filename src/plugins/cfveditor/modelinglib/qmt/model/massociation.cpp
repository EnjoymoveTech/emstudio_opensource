...
QString MAssociationEnd::kindName() const
{
    switch(m_kind)
    {
...
void MAssociation::setEventMap(QHash<QString, QString> map)
{
    m_eventMap = map;
}

void MAssociation::setFieldMap(QHash<QString, QString> map)
{
    m_fieldMap = map;
}

void MAssociation::setPinMap(QHash<QString, QString> map)
{
    m_pinMap = map;
}
