...
MRelation::MRelation(const MRelation &rhs)
    : MElement(rhs),
      ...
      m_endAOid(rhs.m_endAOid),
      m_endBOid(rhs.m_endBOid),
      m_endAName(rhs.m_endAName),
      m_endBName(rhs.m_endBName)
{
}
...
void MRelation::setEndAOid(const QString &oid)
{
    m_endAOid = oid;
}

void MRelation::setEndBOid(const QString &oid)
{
    m_endBOid = oid;
}

void MRelation::setEndAName(const QString &name)
{
    m_endAName = name;
}

void MRelation::setEndBName(const QString &name)
{
    m_endBName = name;
}
