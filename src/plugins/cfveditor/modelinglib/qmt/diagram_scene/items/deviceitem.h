...
class DeviceItem :
        ...
        public IEditable
{
    //Q_DECLARE_TR_FUNCTIONS(qmt::DeviceItem);
    class BoundaryTextItem;

public:
    DeviceItem(DDevice *boundary, DiagramSceneModel *diagramSceneModel,
                 QGraphicsItem *parent = nullptr);
    ~DeviceItem() override;

    DDevice *boundary() const { return m_boundary; }
