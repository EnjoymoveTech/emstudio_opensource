...
const char ACTION_DEPLOYMENT[] = "ModelEditor.Action.Deployment";
...
const char ACTION_SHOW_METHOD[] = "ModelEditor.Action.ShowMethod";
const char ACTION_SHOW_EVENT[] = "ModelEditor.Action.ShowEvent";
const char ACTION_SHOW_FIELD[] = "ModelEditor.Action.ShowField";
const char ACTION_SHOW_PIN[] = "ModelEditor.Action.ShowPin";
const char ACTION_SHOW_ITEM_RELATION[] = "ModelEditor.Action.ShowItemRelation";
...
const char MIME_TYPE_MODEL[] = "application/emos.cfv.model";
...
const char SETTINGS_LEFT_GROUP_SPLITTER[] = "LeftGroupSplitter";
} // namespace Constants
} // namespace ModelEditor
