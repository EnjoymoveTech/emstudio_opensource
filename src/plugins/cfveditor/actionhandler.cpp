...
public:
    ...
    QAction* viewComponentAction;
    QAction* viewMethodAction;
    QAction* viewEventAction;
    QAction* viewFieldAction;
    QAction* viewPinAction;
    QAction* autoConnectAction;
    QAction* disconnectAction;
    QAction* beautifulConnectAction;
};
...
QAction *ActionHandler::panAction() const
{
    return d->panAction;
}

QAction *ActionHandler::viewComponentAction() const
{
    return d->viewComponentAction;
}

QAction *ActionHandler::viewMethodAction() const
{
    return d->viewMethodAction;
}

QAction *ActionHandler::viewEventAction() const
{
    return d->viewEventAction;
}

QAction *ActionHandler::viewFieldAction() const
{
    return d->viewFieldAction;
}

QAction *ActionHandler::viewPinAction() const
{
    return d->viewPinAction;
}

QAction *ActionHandler::autoConnectAction() const
{
    return d->autoConnectAction;
}

QAction *ActionHandler::disconnectAction() const
{
    return d->disconnectAction;
}

QAction *ActionHandler::beautifulConnectAction() const
{
    return d->beautifulConnectAction;
}
...
void ActionHandler::createActions()
{
    ...
    Core::Command *exportDiagramCommand = registerCommand(
                ...
                tr("Export Diagram..."), QKeySequence(), Utils::Icons::PICTURE_TOOLBAR.icon());
    ...
    d->panAction = new QAction(Utils::Icons::PAN_TOOLBAR.icon(), tr("pan"), this);
    d->panAction->setCheckable(true);
    d->panAction->setChecked(false);

    d->viewComponentAction = new QAction(QIcon(":/modelinglib/48x48/component.png"), tr("component"), this);
    d->viewComponentAction->setCheckable(true);
    d->viewComponentAction->setChecked(false);
    d->viewMethodAction = new QAction(QIcon(":/modeleditor/method.png"), tr("method"), this);
    d->viewMethodAction->setCheckable(true);
    d->viewMethodAction->setChecked(true);
    d->viewEventAction = new QAction(QIcon(":/modeleditor/event.png"), tr("event"), this);
    d->viewEventAction->setCheckable(true);
    d->viewEventAction->setChecked(true);
    d->viewFieldAction = new QAction(QIcon(":/modeleditor/field.png"), tr("field"), this);
    d->viewFieldAction->setCheckable(true);
    d->viewFieldAction->setChecked(true);
    d->viewPinAction = new QAction(QIcon(":/modeleditor/pin.png"), tr("pin"), this);
    d->viewPinAction->setCheckable(true);
    d->viewPinAction->setChecked(true);

    d->autoConnectAction = new QAction(Utils::Icons::CONNECT_TOOLBAR.icon(), tr("auto connect"), this);
    d->disconnectAction = new QAction(Utils::Icons::DISCONNECT_TOOLBAR.icon(), tr("all disconnect"), this);
    d->beautifulConnectAction = new QAction(Utils::Icons::BEAUTIFULCONNECT_TOOLBAR.icon(), tr("beautiful connect"), this);
}
