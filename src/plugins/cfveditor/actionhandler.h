...
public:
    ...
    QAction *panAction() const;
    QAction *viewComponentAction() const;
    QAction *viewMethodAction() const;
    QAction *viewEventAction() const;
    QAction *viewFieldAction() const;
    QAction *viewPinAction() const;
    QAction *autoConnectAction() const;
    QAction *disconnectAction() const;
    QAction *beautifulConnectAction() const;
