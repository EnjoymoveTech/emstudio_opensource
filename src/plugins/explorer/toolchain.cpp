...
static const char LANGUAGE_KEY_V1[] = "ProjectExplorer.ToolChain.Language"; // For EmStudio <= 4.2
static const char LANGUAGE_KEY_V2[] = "ProjectExplorer.ToolChain.LanguageV2"; // For EmStudio > 4.2
...
// Deprecated used from EmStudio <= 4.2
