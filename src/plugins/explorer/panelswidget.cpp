...
PanelsWidget::PanelsWidget(QWidget *parent, bool bar)
    : QWidget(parent), m_splitter(new Core::MiniSplitter(this))
{
    ...
    m_splitter->setStretchFactor(1, 1); // Force root widget to its minimum size initially
...
PanelsWidget::PanelsWidget(const QString &displayName, const QIcon &icon, QWidget *widget, bool bar)
    : PanelsWidget(nullptr, bar)
{
