...
const char G_FILE_BUILD[]         = "ProjectFile.Group.Build";
...
const char C_IDL_MIMETYPE[] = "application/emos.idl.xml";
const char C_CFV_MIMETYPE[] = "application/emos.cfv.model";
...
// File icon overlays
const char FILEOVERLAY_QRC[]=":/explorer/images/fileoverlay_qrc.png";
const char FILEOVERLAY_UNKNOWN[]=":/explorer/images/fileoverlay_unknown.png";

//lingfei.yu特殊文件夹的内容
const char FOLDER_INERFACE_CLOSE[]=":/explorer/images/folder_interface_close.png";
const char FOLDER_COMPONENT_CLOSE[]=":/explorer/images/folder_component_close.png";
const char FOLDER_ARCHITECTURE_CLOSE[]=":/explorer/images/folder_architecture_close.png";
const char FOLDER_SCHEDULE_CLOSE[]=":/explorer/images/folder_schedule_close.png";
const char FOLDER_CONFIG_CLOSE[]=":/explorer/images/folder_config_close.png";
const char FILEOVERLAY_PRODUCT[] = ":/explorer/images/folder_product_close.png";

//lingfei.yu修改每个文件的内容
const char FILE_IDL[]=":/explorer/images/file_idl.png";
const char FILE_CFV[]=":/explorer/images/file_cfv.png";
const char FILE_SCH[]=":/explorer/images/file_sch.png";
const char FILE_DES[]=":/explorer/images/file_des.png";
