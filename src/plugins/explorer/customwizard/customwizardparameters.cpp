...
TemporaryFileTransform::TemporaryFileTransform(TemporaryFilePtrList *f) :
    m_files(f), m_pattern(Utils::TemporaryDirectory::masterDirectoryPath() + "/emstudioXXXXXX.txt")
{ }
...
void CustomWizardContext::reset()
{
    ...
    baseReplacements.insert(QLatin1String("CppSourceSuffix"),
                            Utils::mimeTypeForName(QLatin1String("text/x-c++src"))
                            .preferredSuffix());
    baseReplacements.insert(QLatin1String("CppHeaderSuffix"),
                            Utils::mimeTypeForName(QLatin1String("text/x-c++hdr"))
                            .preferredSuffix());
