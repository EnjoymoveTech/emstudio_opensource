...
namespace Utils {
class EMSTUDIO_UTILS_EXPORT FadingPanel : public QWidget
{
    Q_OBJECT
...
class EMSTUDIO_UTILS_EXPORT FadingWidget : public FadingPanel
{
    Q_OBJECT
public:
...
class EMSTUDIO_UTILS_EXPORT DetailsButton : public QAbstractButton
{
    Q_OBJECT
...
class EMSTUDIO_UTILS_EXPORT ExpandButton : public QAbstractButton
{
    Q_OBJECT
