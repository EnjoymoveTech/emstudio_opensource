...
class EMSTUDIO_UTILS_EXPORT SynchronousProcessResponse
{
public:
    enum Result {
...
EMSTUDIO_UTILS_EXPORT QDebug operator<<(QDebug str, const SynchronousProcessResponse &);

using ExitCodeInterpreter = std::function<SynchronousProcessResponse::Result(int /*exitCode*/)>;
EMSTUDIO_UTILS_EXPORT SynchronousProcessResponse::Result defaultExitCodeInterpreter(int code);

class EMSTUDIO_UTILS_EXPORT SynchronousProcess : public QObject
{
    Q_OBJECT
public:
    enum Flags {
