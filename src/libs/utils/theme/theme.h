...
class EMSTUDIO_UTILS_EXPORT Theme : public QObject
{
    Q_OBJECT
...
private:
    friend EMSTUDIO_UTILS_EXPORT Theme *creatorTheme();
    friend EMSTUDIO_UTILS_EXPORT Theme *proxyTheme();
    QPair<QColor, QString> readNamedColor(const QString &color) const;
};

EMSTUDIO_UTILS_EXPORT Theme *creatorTheme();
EMSTUDIO_UTILS_EXPORT Theme *proxyTheme();
