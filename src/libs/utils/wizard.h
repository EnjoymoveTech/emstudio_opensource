...
class EMSTUDIO_UTILS_EXPORT Wizard : public QWizard
{
    Q_OBJECT
...
class EMSTUDIO_UTILS_EXPORT WizardProgress : public QObject
{
    Q_OBJECT
...
class EMSTUDIO_UTILS_EXPORT WizardProgressItem // managed by WizardProgress
{
