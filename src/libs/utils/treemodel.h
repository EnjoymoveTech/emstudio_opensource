...
class EMSTUDIO_UTILS_EXPORT TreeItem
{
public:
    TreeItem();
    virtual ~TreeItem();
...
class EMSTUDIO_UTILS_EXPORT StaticTreeItem : public TreeItem
{
public:
...
class EMSTUDIO_UTILS_EXPORT BaseTreeModel : public QAbstractItemModel
{
    Q_OBJECT
