...
void FramelessWidget::setWidget(QWidget *widget)
{
    if (this->widget == 0) {
        this->widget = widget;
        this->widget->setAttribute(Qt::WA_Hover);
        //this->widget->setAttribute(Qt::WA_StyledBackground);      //启用样式背景绘制
        //this->widget->setAttribute(Qt::WA_TranslucentBackground); //背景透明
        //设置鼠标追踪为真
        ...
        //this->widget->setContentsMargins(8,8,8,8);
    }
}
}
