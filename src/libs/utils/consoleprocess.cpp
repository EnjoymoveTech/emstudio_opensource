...
bool ConsoleProcess::start()
{
    ...
    const QString cmdLine = createWinCommandline(
            QCoreApplication::applicationDirPath() + QLatin1String("/emstudio_process_stub.exe"), stubArgs);
    ...
    const QString stubPath = QCoreApplication::applicationDirPath()
            + QLatin1String("/" QTC_REL_TOOLS_PATH "/emstudio_process_stub");
