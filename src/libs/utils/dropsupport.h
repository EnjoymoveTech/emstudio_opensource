...
class EMSTUDIO_UTILS_EXPORT DropSupport : public QObject
{
    Q_OBJECT
public:
    struct FileSpec {
...
signals:
    ...
    void dragLeaved(QObject *obj, QEvent *event);
...
class EMSTUDIO_UTILS_EXPORT DropMimeData : public QMimeData
{
    Q_OBJECT
public:
    DropMimeData();
