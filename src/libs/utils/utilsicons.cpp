...
const Icon PICTURE_TOOLBAR({
        {QLatin1String(":/utils/images/picture.png"), Theme::IconsBaseColor}});
const Icon HOME({
...
const Icon LOCKED_TOOLBAR({
        {QLatin1String(":/utils/images/toolbar_document_locked.png"), Theme::IconsBaseColor}});
const Icon LOCKED({
        {QLatin1String(":/utils/images/toolbar_document_locked.png"), Theme::PanelTextColorDark}}, Icon::Tint);
const Icon UNLOCKED_TOOLBAR({
        {QLatin1String(":/utils/images/toolbar_document_unlocked.png"), Theme::IconsBaseColor}});
const Icon UNLOCKED({
        {QLatin1String(":/utils/images/toolbar_document_unlocked.png"), Theme::PanelTextColorDark}}, Icon::Tint);
const Icon PINNED({
        {QLatin1String(":/utils/images/pinned.png"), Theme::PanelTextColorDark}}, Icon::Tint);
const Icon NEXT({
        {QLatin1String(":/utils/images/toolbar_next.png"), Theme::IconsWarningColor}}, Icon::MenuTintedStyle);
const Icon NEXT_TOOLBAR({
        {QLatin1String(":/utils/images/toolbar_next.png"), Theme::IconsNavigationArrowsColor}});
const Icon PREV({
        {QLatin1String(":/utils/images/toolbar_prev.png"), Theme::IconsWarningColor}}, Icon::MenuTintedStyle);
const Icon PREV_TOOLBAR({
        {QLatin1String(":/utils/images/toolbar_prev.png"), Theme::IconsNavigationArrowsColor}});
const Icon PROJECT({
...
const Icon OK({
        {QLatin1String(":/utils/images/toolbar_filterok.png"), Theme::IconsRunColor}}, Icon::Tint);
...
const Icon IMPORTA({
        {QLatin1String(":/utils/images/text_append.png"), Theme::IconsBaseColor}});
const Icon IMPORTC({
        {QLatin1String(":/utils/images/import_icon.png"), Theme::IconsBaseColor}});
const Icon EXCEL({
        {QLatin1String(":/utils/images/excel.png"), Theme::IconsRunColor}}, Icon::ToolBarStyle);
const Icon NEWFILE({
...
const Icon CLOSE_TOOLBAR({
        {QLatin1String(":/utils/images/toolbar_close.png"), Theme::IconsBaseColor}});
const Icon CLOSE_FOREGROUND({
        {QLatin1String(":/utils/images/toolbar_close.png"), Theme::PanelTextColorDark}}, Icon::Tint);
const Icon CLOSE_BACKGROUND({
        {QLatin1String(":/utils/images/toolbar_close.png"), Theme::PanelTextColorLight}}, Icon::Tint);
const Icon SPLIT_HORIZONTAL({
        {QLatin1String(":/utils/images/toolbar_horizontalpagination.png"), Theme::PanelTextColorMid}}, Icon::MenuTintedStyle);
const Icon SPLIT_HORIZONTAL_TOOLBAR({
        {QLatin1String(":/utils/images/toolbar_horizontalpagination.png"), Theme::IconsBaseColor}});
const Icon SPLIT_VERTICAL({
        {QLatin1String(":/utils/images/toolbar_verticalpagination.png"), Theme::PanelTextColorMid}}, Icon::MenuTintedStyle);
const Icon SPLIT_VERTICAL_TOOLBAR({
        {QLatin1String(":/utils/images/toolbar_verticalpagination.png"), Theme::IconsBaseColor}});
const Icon CLOSE_SPLIT_TOP({
        {QLatin1String(":/utils/images/toolbar_closetop.png"), Theme::IconsBaseColor}});
const Icon CLOSE_SPLIT_BOTTOM({
        {QLatin1String(":/utils/images/toolbar_closebottom.png"), Theme::IconsBaseColor}});
const Icon CLOSE_SPLIT_LEFT({
        {QLatin1String(":/utils/images/toolbar_closeleft.png"), Theme::IconsBaseColor}});
const Icon CLOSE_SPLIT_RIGHT({
        {QLatin1String(":/utils/images/toolbar_closeright.png"), Theme::IconsBaseColor}});
const Icon FILTER({
        {QLatin1String(":/utils/images/toolbar_filtertree.png"), Theme::IconsBaseColor},
        {QLatin1String(":/utils/images/toolbuttonexpandarrow.png"), Theme::IconsBaseColor}});
const Icon LINK({
        {QLatin1String(":/utils/images/toolbar_link.png"), Theme::PanelTextColorMid}}, Icon::Tint);
const Icon LINK_TOOLBAR({
        {QLatin1String(":/utils/images/toolbar_link.png"), Theme::IconsBaseColor}});
...
const Icon CONNECT_TOOLBAR({
        {QLatin1String(":/utils/images/connect.png"), Theme::IconsBaseColor}});
const Icon DISCONNECT_TOOLBAR({
        {QLatin1String(":/utils/images/disconnect.png"), Theme::IconsBaseColor}});
const Icon BEAUTIFULCONNECT_TOOLBAR({
        {QLatin1String(":/utils/images/beautifulconnect.png"), Theme::IconsBaseColor}});
const Icon DOWNLOAD({
