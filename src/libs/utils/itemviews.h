...
class EMSTUDIO_UTILS_EXPORT TreeView : public View<QTreeView>
{
    Q_OBJECT
public:
...
class EMSTUDIO_UTILS_EXPORT TreeWidget : public View<QTreeWidget>
{
    Q_OBJECT
public:
...
class EMSTUDIO_UTILS_EXPORT ListView : public View<QListView>
{
    Q_OBJECT
public:
...
class EMSTUDIO_UTILS_EXPORT ListWidget : public View<QListWidget>
{
    Q_OBJECT
public:
