...
EMSTUDIO_UTILS_EXPORT QDebug operator<<(QDebug dbg, const Utils::FilePath &c);
...
class EMSTUDIO_UTILS_EXPORT FilePath
{
public:
    FilePath();
...
EMSTUDIO_UTILS_EXPORT QTextStream &operator<<(QTextStream &s, const FilePath &fn);

using FilePaths = QList<FilePath>;

class EMSTUDIO_UTILS_EXPORT CommandLine
{
public:
    enum RawType { Raw };
...
class EMSTUDIO_UTILS_EXPORT FileUtils {
public:
#ifdef QT_GUI_LIB
    class EMSTUDIO_UTILS_EXPORT CopyAskingForOverwrite
    {
    public:
...
template <>
EMSTUDIO_UTILS_EXPORT void withNtfsPermissions(const std::function<void()> &task);
...
class EMSTUDIO_UTILS_EXPORT FileReader
{
...
class EMSTUDIO_UTILS_EXPORT FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
    FileSaverBase();
...
class EMSTUDIO_UTILS_EXPORT FileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
class EMSTUDIO_UTILS_EXPORT TempFileSaver : public FileSaverBase
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
...
class EMSTUDIO_UTILS_EXPORT XmlFileSaver : public FileSaver
{
    Q_DECLARE_TR_FUNCTIONS(Utils::FileUtils) // sic!
public:
    // QIODevice::WriteOnly is implicit
    explicit XmlFileSaver(const QString &filename, QIODevice::OpenMode mode = QIODevice::NotOpen);
    bool write(QDomDocument *doc);

    static QString serializeStr(QDomDocument *doc);
    static QString serializeStr(const QString& content);
private:
    static void saveNodeCanonically(QXmlStreamWriter *stream, const QDomNode &domNode);
};
...
namespace std {
template<> struct EMSTUDIO_UTILS_EXPORT hash<Utils::FilePath>
{
