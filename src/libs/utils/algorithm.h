...
/////////////////////////
// findOr 返回符合条件的元素，需要传入默认值对应没有找到的情况
/////////////////////////
...
/////////////////////////
// findOrDefault  返回符合条件的元素，没有找到返回 C::value_type()
/////////////////////////
template<typename C, typename F>
...
/////////////////////////
// filteredUnique 筛选出不重复的值
/////////////////////////
template<typename C>
Q_REQUIRED_RESULT C filteredUnique(const C &container);

/////////////////////////
// qobject_container_cast  批量qobject_cast转换
/////////////////////////
...
/////////////////////////
// static_container_cast  批量static_cast转换
/////////////////////////
template<class T, template<typename> class Container, typename Base>
...
struct CompareIter
{
    ...
    explicit  CompareIter(Compare compare)
