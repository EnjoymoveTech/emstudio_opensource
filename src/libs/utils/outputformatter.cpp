...
void OutputFormatter::initFormats()
{
    ...
    d->formats[WarningMessageFormat].setForeground(theme->color(Theme::OutputPanes_WarningMessageTextColor));
    d->formats[ErrorMessageFormat].setForeground(theme->color(Theme::OutputPanes_ErrorMessageTextColor));
    d->formats[LogMessageFormat].setForeground(theme->color(Theme::OutputPanes_DebugTextColor));
...
void OutputFormatter::setBoldFontEnabled(bool enabled)
{
    ...
    d->formats[WarningMessageFormat].setFontWeight(fontWeight);
