...
class EMSTUDIO_UTILS_EXPORT FileIterator
{
public:
    class Item
    {
...
class EMSTUDIO_UTILS_EXPORT FileListIterator : public FileIterator
{
public:
...
class EMSTUDIO_UTILS_EXPORT SubDirFileIterator : public FileIterator
{
public:
...
class EMSTUDIO_UTILS_EXPORT FileSearchResult
{
public:
...
EMSTUDIO_UTILS_EXPORT QFuture<FileSearchResultList> findInFiles(const QString &searchTerm, FileIterator *files,
    QTextDocument::FindFlags flags, const QMap<QString, QString> &fileToContentsMap = QMap<QString, QString>());

EMSTUDIO_UTILS_EXPORT QFuture<FileSearchResultList> findInFilesRegExp(const QString &searchTerm, FileIterator *files,
    QTextDocument::FindFlags flags, const QMap<QString, QString> &fileToContentsMap = QMap<QString, QString>());

EMSTUDIO_UTILS_EXPORT QString expandRegExpReplacement(const QString &replaceText, const QStringList &capturedTexts);
EMSTUDIO_UTILS_EXPORT QString matchCaseReplacement(const QString &originalText, const QString &replaceText);
