...
class EMSTUDIO_UTILS_EXPORT ProgressParser
{
public:
    ProgressParser();
...
class EMSTUDIO_UTILS_EXPORT OutputProxy : public QObject
{
    Q_OBJECT
...
class EMSTUDIO_UTILS_EXPORT ShellCommand : public QObject
{
    Q_OBJECT
