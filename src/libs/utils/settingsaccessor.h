...
EMSTUDIO_UTILS_EXPORT int versionFromMap(const QVariantMap &data);
EMSTUDIO_UTILS_EXPORT int originalVersionFromMap(const QVariantMap &data);
EMSTUDIO_UTILS_EXPORT QByteArray settingsIdFromMap(const QVariantMap &data);

EMSTUDIO_UTILS_EXPORT void setVersionInMap(QVariantMap &data, int version);
EMSTUDIO_UTILS_EXPORT void setOriginalVersionInMap(QVariantMap &data, int version);
EMSTUDIO_UTILS_EXPORT void setSettingsIdInMap(QVariantMap &data, const QByteArray &id);
...
class EMSTUDIO_UTILS_EXPORT SettingsAccessor
{
public:
...
class EMSTUDIO_UTILS_EXPORT BackUpStrategy
{
public:
...
class EMSTUDIO_UTILS_EXPORT BackingUpSettingsAccessor : public SettingsAccessor
{
public:
...
class EMSTUDIO_UTILS_EXPORT VersionedBackUpStrategy : public BackUpStrategy
{
public:
...
class EMSTUDIO_UTILS_EXPORT VersionUpgrader
{
public:
...
class EMSTUDIO_UTILS_EXPORT UpgradingSettingsAccessor : public BackingUpSettingsAccessor
{
public:
...
class EMSTUDIO_UTILS_EXPORT MergingSettingsAccessor : public UpgradingSettingsAccessor
{
public:
...
EMSTUDIO_UTILS_EXPORT QVariant mergeQVariantMaps(const QVariantMap &mainTree, const QVariantMap &secondaryTree,
