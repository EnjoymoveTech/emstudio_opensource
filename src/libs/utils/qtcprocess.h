...
class EMSTUDIO_UTILS_EXPORT QtcProcess : public QProcess
{
    Q_OBJECT
...
public:
    ...
    class EMSTUDIO_UTILS_EXPORT Arguments
    {
    public:
     ...
     */
    class EMSTUDIO_UTILS_EXPORT ArgIterator {
    public:
    ...
    class EMSTUDIO_UTILS_EXPORT ConstArgIterator {
    public:
