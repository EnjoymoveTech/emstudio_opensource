...
class EMSTUDIO_UTILS_EXPORT Id
{
public:
    Id() = default;
...
QT_BEGIN_NAMESPACE
EMSTUDIO_UTILS_EXPORT QDataStream &operator<<(QDataStream &ds, Utils::Id id);
EMSTUDIO_UTILS_EXPORT QDataStream &operator>>(QDataStream &ds, Utils::Id &id);
EMSTUDIO_UTILS_EXPORT QDebug operator<<(QDebug dbg, const Utils::Id &id);
QT_END_NAMESPACE
