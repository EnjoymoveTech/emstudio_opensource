...
Project {
    ...
    QtcLibrary {
        ...
        Group {
            ...
            qbs.installSourceBase: project.ide_source_tree + "/src/libs/thirdparty/syntax-highlighting/data/"
            prefix: project.ide_source_tree + "/src/libs/thirdparty/syntax-highlighting/data/"
            files: [
                "syntax/**/*"
            ]
        }
