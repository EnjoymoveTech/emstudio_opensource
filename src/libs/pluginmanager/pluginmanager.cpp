...
Q_LOGGING_CATEGORY(pluginLog, "qtc.pluginmanager", QtWarningMsg)
...
/*!
    ...
    \inheaderfile pluginmanager/pluginmanager.h
    \inmodule EmStudio
    \ingroup mainclasses
    ...
    \c "org.qt-project.Qt.EmStudioPlugin".
...
static const QStringList pluginFiles(const QStringList &pluginPaths)
{
    ...
    while (!searchPaths.isEmpty()) {
        ...
        QStringList absoluteFilePaths ;//= Utils::transform(files, &QFileInfo::absoluteFilePath);
        for(QFileInfo temInfo:files)
        {

            absoluteFilePaths << temInfo.absoluteFilePath();
